...
contract FlightSuretyApp {
    ...
    // constant variables 
    uint8 private constant MULTIPARTY_THRESHOLD = 4;
    uint8 private constant VOTE_SUCCESS_THRESHOLD = 2;

    uint256 public constant PASSENGER_INSURANCE_AMOUNT = 1 ether;
    uint256 public constant MIN_AIRLINE_ANTE = 10 ether;
    ...
    modifier requireContractOwner()
    {
      ...
      modifier requireRegisteredAirlineCaller() {
        require(
            ...
            "Only existing airline may register an airline or participate in consensus"
        );
        _;
    }
     ...
     modifier requireNotRegistered(address airlineAddress) {
        ...
        require(
            msg.value <= PASSENGER_INSURANCE_AMOUNT,
